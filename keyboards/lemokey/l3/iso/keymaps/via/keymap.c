...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [BASE] = LAYOUT_iso_tkl(
        ...
        MC_3,     KC_LCTL,  KC_LWIN,  KC_LALT,                                KC_SPC,                                 KC_RALT,  MO(FN),   KC_RWIN,    KC_RCTL,  KC_LEFT,  KC_DOWN,  KC_RGHT),
    [FN] = LAYOUT_iso_tkl(
        ...
        _______,  _______,  GUI_TOG,  _______,                                _______,                                _______,  _______,  QK_LOCK,    _______,  _______,  _______,  _______),
};
// clang-format on
